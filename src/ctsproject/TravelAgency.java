...
public class TravelAgency {
	...
	List<Package> findPackagesWithMinimumNumberOfDays(){
		String sql="select *  from package_details group by package_id having min(no_of_days)";
		return null;
	}
	...
	List<Package>generatePackageCost(String filePath) throws IOException, SQLException{
		int discount=0;
		try {
			connection=DBHandler.esatblishConnection();
		}
		...
		System.out.println("DRecord processed");
		return list;	
	}
